...
namespace Shop
{
    class _Main
    {
        static void Main(string[] args)
        {
            ...
            Order order = new Order("Fruits",110);
                ...
                switch (choise)
                {
                    ...
                    case 2:
                        try
                        {
                            ...
                            ShopMain.AddToBasket(customer1,order, number, quantity);
                        }
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        ShopMain.ClearBasket(customer1,order, AllProducts);
                        ShopMain.RecovoryList(ref TempProduct);
                        break;
                    case 6:
                        Console.WriteLine("Purchase Information:");
                        Console.WriteLine("Name of Shop: {0}", ShopMain._NameShop);
                        Console.WriteLine("Type of order and number: {0} -- №_{1}", order._TypeOfOrder, order._NumberOfOrder);
